...
<script :src="require('../../node_modules/@nyaruka/flow-editor/build/static/js/3.9d439a3b.chunk.js')"></script>
<script :src="require('../../node_modules/@nyaruka/flow-editor/build/static/js/main.45f007fe.chunk.js')"></script>
<script :src="require('../../node_modules/@nyaruka/flow-editor/build/static/js/runtime-main.7f0aa66d.js')"></script>
<script :src="require('../../node_modules/@nyaruka/flow-editor/build/static/js/2.68722ea4.chunk.js')"></script>
<script>
...
export default {
  ...
  mounted() {
    ...
    const base = 'http://127.0.0.1:8000/ussd/';
    const config = {
      flow: uuid,
      flowType: 'messaging',
      localStorage: true,
